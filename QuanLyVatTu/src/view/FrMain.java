...
public class FrMain extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnCenter.setPreferredSize(new java.awt.Dimension(810, 500));
        ...
        jMenuBaoCao.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baocao.png"))); // NOI18N
        jMenuBaoCao.setText("Báo cáo");
        jMenuBaoCao.setFont(new java.awt.Font("Segoe UI", 1, 12)); // NOI18N

        jMenuItem2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/pie-chart-icon.png"))); // NOI18N
        jMenuItem2.setText("Báo cáo Xuất");
        jMenuItem2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem2ActionPerformed(evt);
            }
        });
        jMenuBaoCao.add(jMenuItem2);

        jMenuItem3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/baocao-icon.png"))); // NOI18N
        jMenuItem3.setText("Báo cáo nhập");
        jMenuItem3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jMenuItem3ActionPerformed(evt);
            }
        });
        jMenuBaoCao.add(jMenuItem3);
        ...
        jMenuBar1.getAccessibleContext().setAccessibleName("Phần mềm quản lý kho vật tư y tế");
